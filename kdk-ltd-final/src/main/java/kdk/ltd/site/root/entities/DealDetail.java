...
public class DealDetail extends Detail  {
    ...
    public DealDetail(Product product, Integer quantity, BigDecimal sum, Storage storage, FactDeal document) {
        this(product, quantity, sum);
        this.storage = storage;
        this.document = document;
    }

    public FactDeal getDocument() {
        return document;
    }

    public void setDocument(FactDeal document) {
        this.document = document;
    }
