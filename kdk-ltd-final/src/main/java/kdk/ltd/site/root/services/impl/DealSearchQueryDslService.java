...
@Service
public class DealSearchQueryDslService implements DealSearchService<FactDeal> {

    @Inject
    private FactDealRepository repository;

    @Override
    public Page<FactDeal> search(DealSearchCriteria criteria, Pageable pageable) {
